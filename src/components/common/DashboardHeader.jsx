...
export default function DashboardHeader({ user, setMobileSidebarOpen }) {
  ...
  const clearAllNotifications = async () => {
    try {
      const { data } = await authClient.getSession();
      await api.clearNotifications(data?.session?.token);
      setNotifications([]);
