...
import { HiXMark, HiArrowUpTray, HiBuildingOffice2 } from "react-icons/hi2";
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-md p-4 overflow-y-auto">
      <div className="bg-[#0b0b0f] border border-white/10 rounded-3xl w-full max-w-xl p-6 sm:p-8 relative shadow-2xl my-8">
        ...
        <button
          onClick={onClose}
          className="absolute top-6 right-6 text-gray-400 hover:text-white transition p-1.5 rounded-full bg-white/5 border border-white/10"
        >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center justify-end gap-3 pt-4 border-t border-white/10 mt-6">
            <button
              type="button"
              onClick={onClose}
              className="px-6 py-2.5 rounded-xl bg-white/5 border border-white/10 text-xs font-medium text-gray-300 hover:bg-white/10 transition"
            >
              Cancel
            </button>
            <button
              type="submit"
              className="px-6 py-2.5 rounded-xl bg-white text-black text-xs font-bold hover:bg-gray-200 transition shadow-lg"
            >
              Register Company
            </button>
          </div>
