...
export default function AdminUsersPage() {
  ...
  const firstVisible = users.length ? (page - 1) * PAGE_SIZE + 1 : 0;
  const lastVisible = Math.min(page * PAGE_SIZE, users.length);
