...
export default function AdminPaymentsPage() {
  ...
  return <main className="min-w-0 space-y-7 text-white">
    <div><h1 className="mt-4 text-2xl font-semibold tracking-tight sm:text-3xl">Payments &amp; Subscriptions</h1><p className="mt-2 text-xs text-gray-400 sm:text-sm">Comprehensive overview of platform revenue and active subscriptions.</p></div>
