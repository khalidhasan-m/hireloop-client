  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        const response = await fetch(`${API}/admin/payments`, { headers: { Authorization: `Bearer ${token}` }, credentials: "include" });
