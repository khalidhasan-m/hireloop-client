...
export default function AdminPaymentsPage() {
  ...
  const applyUpgrade = async () => {
    ...
    if (!window.confirm(`Upgrade this ${selectedUser?.role || "user"} to ${upgradePlan}?`)) return;
    setUpgrading(true);
    try {
      const token = (await authClient.getSession()).data?.session?.token;
      ...
      setSelectedUserId(""); setUpgradePlan("");
